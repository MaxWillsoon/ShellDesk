...
const windowsX64 = (name) => /\.(exe|msi)$/i.test(name) && includesAny(name, ['x64', 'x86_64', 'amd64']);
const windowsArm64 = (name) => /\.(exe|msi)$/i.test(name) && includesAny(name, ['arm64', 'aarch64']);
...
const platformCandidates = {
  'windows-x86_64': [windowsX64, (name) => /\.(exe|msi)$/i.test(name) && !includesAny(name, ['arm64', 'aarch64', 'i686', 'ia32'])],
