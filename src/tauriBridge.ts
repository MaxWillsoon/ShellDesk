...
window.guiSSH = {
  ...
  connections: {
    ...
    runCommandStream,
    httpTunnelGet: (request) => ipc('http_tunnel_get', request),
    httpTunnelPost: (request) => ipc('http_tunnel_post', request),
    httpTunnelPut: (request) => ipc('http_tunnel_put', request),
    httpTunnelDelete: (request) => ipc('http_tunnel_delete', request),
